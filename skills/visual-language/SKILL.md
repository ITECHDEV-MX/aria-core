---
name: aria-core-visual-language
description: >
  Visual language rules for AriaCore surfaces. Trigger: Any dashboard styling,
...
1. The dashboard must feel like AriaCore, not a generic SaaS admin.
