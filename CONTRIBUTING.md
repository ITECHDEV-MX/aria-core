# Contributing to AriaCore

Thanks for contributing. AriaCore enforces a strict **issue-first workflow** — every change starts with an approved issue.
...
AriaCore uses a lightweight, regular cadence so contributors know what to expect.
...
- Issues that are vague, a duplicate, or belong in [Discussions](https://github.com/ITECHDEV-MX/aria-core/discussions)
