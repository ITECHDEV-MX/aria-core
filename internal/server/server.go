// Package server provides the HTTP API for AriaCore.
//
...
// by autosync.Manager and injected from cmd/aria-core/main.go.
...
func (s *Server) handleExport(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Content-Disposition", "attachment; filename=aria-core-export.json")
