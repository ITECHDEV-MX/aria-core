// Package version checks for newer aria-core releases on GitHub.
package version
...
func updateInstructions() string {
	switch runtime.GOOS {
	case "darwin":
		return "  brew update && brew upgrade aria-core"
	case "linux":
		return "  brew update && brew upgrade aria-core\n  or: go install github.com/ITECHDEV-MX/aria-core/cmd/aria-core@latest"
	default:
		return "  go install github.com/ITECHDEV-MX/aria-core/cmd/aria-core@latest\n  or: https://github.com/ITECHDEV-MX/aria-core/releases/latest"
	}
}
