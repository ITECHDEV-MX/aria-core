...
func (rt *RemoteTransport) ReadManifest() (*coresync.Manifest, error) {
...
func (rt *RemoteTransport) WriteManifest(_ *coresync.Manifest) error {
	return nil
}

func (rt *RemoteTransport) WriteChunk(chunkID string, data []byte, entry coresync.ChunkEntry) error {
...
func (rt *RemoteTransport) ReadChunk(chunkID string) ([]byte, error) {
	...
	if resp.StatusCode == http.StatusNotFound {
		return nil, coresync.ErrChunkNotFound
	}
	if resp.StatusCode != http.StatusOK {
		body, _ := io.ReadAll(resp.Body)
