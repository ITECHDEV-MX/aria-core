...
import (
	...
	"github.com/ITECHDEV-MX/aria-core/internal/version"
)
...
func TestRenderObservationListItem(t *testing.T) {
	...
	if !strings.Contains(line, "aria-core") {
...
func TestViewDashboardSearchAndRecent(t *testing.T) {
	...
	out := m.viewDashboard()
	if !strings.Contains(out, "aria-core") || !strings.Contains(out, "Actions") {
...
func TestViewObservationDetailTimelineSessionsAndSessionDetail(t *testing.T) {
	...
	m.Timeline = &store.TimelineResult{
		...
		SessionInfo:  &store.Session{ID: "session-1", Project: "aria-core"},
		TotalInRange: 3,
	}
	out = m.viewTimeline()
	...
	m.Sessions = []store.SessionSummary{
		{ID: "s1", Project: "aria-core", StartedAt: "2026-01-01", Summary: &summary, ObservationCount: 2},
		{ID: "s2", Project: "aria-core", StartedAt: "2026-01-02", ObservationCount: 1},
		{ID: "s3", Project: "aria-core", StartedAt: "2026-01-03", ObservationCount: 1},
		{ID: "s4", Project: "aria-core", StartedAt: "2026-01-04", ObservationCount: 1},
		{ID: "s5", Project: "aria-core", StartedAt: "2026-01-05", ObservationCount: 1},
		{ID: "s6", Project: "aria-core", StartedAt: "2026-01-06", ObservationCount: 1},
		{ID: "s7", Project: "aria-core", StartedAt: "2026-01-07", ObservationCount: 1},
	}
	out = m.viewSessions()
...
func TestViewRouterCoversAllScreens(t *testing.T) {
	...
	m.Sessions = []store.SessionSummary{{ID: "s1", Project: "aria-core", StartedAt: "now", ObservationCount: 1}}
	m.SelectedSessionIdx = 0
