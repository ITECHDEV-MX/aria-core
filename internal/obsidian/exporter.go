...
// ariaCoreRoot returns the {vault}/aria-core/ root path.
func (e *Exporter) ariaCoreRoot() string {
	return filepath.Join(e.config.VaultPath, "aria-core")
}

// stateFilePath returns the path to the sync state JSON file.
func (e *Exporter) stateFilePath() string {
	return filepath.Join(e.ariaCoreRoot(), ".aria-core-sync-state.json")
}
