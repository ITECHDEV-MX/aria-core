...
```
ok  github.com/ITECHDEV-MX/aria-core/cmd/aria-core           2.132s
ok  github.com/ITECHDEV-MX/aria-core/internal/cloud/autosync   0.646s
ok  github.com/ITECHDEV-MX/aria-core/internal/cloud/cloudserver  0.059s
ok  github.com/ITECHDEV-MX/aria-core/internal/cloud/remote  0.037s
...
| `cmd/aria-core` | 78.4% (autosync_status.go: 87.6% weighted) |
...
| REQ-209: autosyncStatusAdapter with phase mapping | IMPLEMENTED | `cmd/aria-core/autosync_status.go:25-55` |
| REQ-210: ARIA_CORE_CLOUD_AUTOSYNC=1 opt-in only | IMPLEMENTED | `main.go:643` — exact "1" check |
