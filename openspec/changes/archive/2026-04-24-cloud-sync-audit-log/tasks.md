...
- [x] 3.3.2 Run `gofmt -l ./internal/cloud/... ./cmd/aria-core/...`; fix any formatting drift.
- [x] 3.3.3 Run `go test ./...` (non-Postgres-gated tests); confirm green.
- [x] 3.3.4 Run `go test -race ./internal/cloud/... ./cmd/aria-core/...`; confirm no race conditions.
