...
CLI command that reads the AriaCore SQLite store and writes a structured Obsidian-compatible markdown vault with YAML frontmatter, wikilinks, hub notes, and incremental sync state.
