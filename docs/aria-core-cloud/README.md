...
**Use AriaCore Cloud when you want shared, project-scoped memory across machines without giving up local-first ownership.**

Local SQLite remains authoritative. AriaCore Cloud is optional replication + browser visibility for teams and operators.

<p align="center">
  <img src="../../assets/branding/aria-core-cloud-logo.png" alt="AriaCore Cloud" width="960" />
</p>
...
## What AriaCore Cloud Is

- **Project-scoped replication**: each sync call is tied to one explicit `--project`
- **Self-hosted cloud runtime**: `aria-core cloud serve` on infrastructure you control
...
| [Branding](./branding.md) | AriaCore Cloud visual identity, asset usage, previews |
