...
// teamProjectsAdapter implementa knowledgebase.ProjectReader sobre
...
func (a *teamProjectsAdapter) GetProject(ctx context.Context, id string) (*knowledgebase.ProjectInfo, error) {
	if a == nil || a.db == nil {
...
func (a *teamProjectsAdapter) loadMembers(ctx context.Context, projectID string) []knowledgebase.ProjectMember {
...
func (a *teamProjectsAdapter) ListProjects(ctx context.Context) ([]knowledgebase.ProjectInfo, error) {
	if a == nil || a.db == nil {
		return nil, nil
	}
	rows, err := a.db.QueryContext(ctx, `
...
func (a *teamProjectsAdapter) ResolveProjectIDBySlug(ctx context.Context, slug string) (string, error) {
	if a == nil || a.db == nil {
		return "", nil
	}
	var id string
...
func newKnowledgeBaseRuntime(cs *cloudstore.CloudStore, cotizadorStore *cotizador.Store, pagesStore pages.Store, publicURL string) (knowledgebase.Service, dashboard.KnowledgeBaseDashboardService) {
	...
	svc := knowledgebase.NewService(knowledgebase.Config{
		...
		Projects:           &teamProjectsAdapter{db: cs.DB()},
